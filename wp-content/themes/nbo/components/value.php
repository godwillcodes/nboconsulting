<section class="bg-gray-100 py-16">
    <div class="max-w-7xl mx-auto px-6 md:px-8 lg:px-0">
        ...
        <div class="border-l-4 border-[#1ca56f] pl-4">
            <h1 class="text-[32px] md:text-[40px] font-extrabold mb-1">
                <span class="text-[#005282]">What We</span>
                <span class="text-[#1ca56f]">Do</span>
            </h1>

            <p class="text-gray-600 mt-2 text-[16px] md:text-[18px] sm:text-lg">
            ...
            <?php for ($i = 0; $i < 5; $i++) { ?>
                ...
                <div class="relative group text-white p-6 flex flex-col items-center justify-end h-80 sm:h-96">
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <h3 class="text-lg sm:text-xl font-semibold">Global BPO Strategy</h3>
                    </div>
                </div>
